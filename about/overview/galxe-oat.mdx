...
* Event organizers can create their dedicated pages on [app.galxe.com](https://app.galxe.com/), create events and credentials just by submitting the parameters and the design of the badge.
