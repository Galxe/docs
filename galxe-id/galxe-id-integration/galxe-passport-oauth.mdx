...
Galxe Passport Oauth does not allow the acquisition of KYC data for the time being, but you can determine whether the user has a Pass through the following methods
