...
Galxe Identity Protocol Typescript SDK is compatible with both node and browser.

For more detailed information, check out our Github repo [here](https://github.com/Galxe/identity-protocol/tree/main/packages/sdk).

Note that in this monorepo you can also find all you need to get started - [SDK](https://github.com/Galxe/identity-protocol/tree/main/packages/sdk), [contracts](https://github.com/Galxe/identity-protocol/tree/main/packages/evm-contracts), [tutorials](https://github.com/Galxe/identity-protocol/tree/main/apps/tutorial), [issuer](https://github.com/Galxe/identity-protocol/tree/main/apps/issuer), etc.

This SDK is also published on npm [here](https://www.npmjs.com/package/@galxe-identity-protocol/sdk).

For examples on how to use the SDK, check out the tutorials in the next section.
