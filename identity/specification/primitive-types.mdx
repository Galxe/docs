...
4. UNIX Timestamp of the holder’s first transaction on Ethereum.
5. ERC20 token balance on height 1000, when representing the token’s total_supply \* decimals requires less than 248 bits. |
...
6. Holder’s first name on passport. |
