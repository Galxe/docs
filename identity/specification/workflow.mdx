...
| ------------------------- | --------------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | --------------- |
| 6.1 Credential revocation | issuer                | Issuers can management the ‘signatures’ they signed on credentials. | 1. expiration. <br/> 2. signature ID via SMT. <br/> 3. explicitly seal the credential. | Credential will be revoked, holder cannot generate proofs that satisfy the goal. | Issuer Registry |
