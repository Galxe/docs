...
GAL has a total supply of 200,000,000 tokens. Please visit [this token table](https://gal.org/token-table) for initial distribution, vesting detail and current circulating supply.
