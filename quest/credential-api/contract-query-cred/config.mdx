...
<Tip>If you want to understand the workflow and considerations of Contract Query credentials, please refer to the [introduction](/quest/credential-api/contract-query-cred/introduction)</Tip>
---
