...
Th following documentation is intended to assist developers to understand and set up advanced credentials (tasks) to be used on Galxe Quest.  For non-developers, the following resources may be more informative for setting up onchain tasks on Galxe Quest.
