...
![Specify Dimensions](images/cred/WX20240801-174031@2x.png "Specify Dimensions")

```java
function(resp) {
  if (BigInt(resp.result)) {
    return {"mainnet_eth_balance":BigInt(resp.result)}
  }
  return 0
}
