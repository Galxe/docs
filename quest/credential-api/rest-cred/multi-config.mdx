...
The option to configure API credential can be found in step 3, [Task Settings](https://help.galxe.com/en/articles/9728885-create-quest-tasks-settings) of quest creation on the Galxe Dashboard.
...
* **Input a test address and send the request to confirm the response**:```json
  {
    "isWhitelisted": true,
    "balance": 1000
  }
...
* **Token Balance Output**:```javascript
  function(resp) {
      return {
